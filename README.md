...
<!-- 🔰 BADGES -->
![GitHub repo size](https://img.shields.io/github/repo-size/codewith-salman/annie-portfolio)
![GitHub stars](https://img.shields.io/github/stars/codewith-salman/annie-portfolio?style=social)
![GitHub forks](https://img.shields.io/github/forks/codewith-salman/annie-portfolio?style=social)

[![Live Demo](https://img.shields.io/badge/Live%20Demo-View%20Project-brightgreen?style=for-the-badge&logo=vercel)](https://annie-portfolio-eight.vercel.app/)
...
<h1 align="center">👩‍🎨 Annie – Personal Portfolio</h1>

A clean, elegant, and fully responsive **Personal Portfolio Website UI** built using **HTML, CSS, and JavaScript**.  
Designed to showcase creativity, projects, and personal branding with a modern and minimal layout.

<a href="https://annie-portfolio-eight.vercel.app/"><strong>➥ Live Demo</strong></a>
...
This project demonstrates your ability to design **personal branding websites**, organize content effectively, and create responsive layouts that adapt beautifully across devices.  
From the hero introduction to project showcases and contact sections, Annie Portfolio delivers a confident and polished digital presence.
